    ...
    private void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (action == null){    
                ...
                articlesMap.put("pageNum", pageNum);
                request.setAttribute("articlesMap", articlesMap);
                nextPage = "/notice_list.jsp";
            }
            /*
            else if(action.equals("/notice_view.do")) {
                nextPage = "/notice_view.jsp";
            }
            */
                ...
                pw.print("<script>" + "  alert('글이 추가되었습니다.');" + " location.href='" + request.getContextPath()
                        + "/board/notice_list.do';" + "</script>");
                ...
                PrintWriter pw = response.getWriter();
                pw.print("<script>" + "  alert('답글이 추가되었습니다.');" + " location.href='" + request.getContextPath()
                        + "/board/viewArticle.do?articleNO="+articleNO+"';" + "</script>");
                return;
        ...
        try {
            ...
            for (int i = 0; i < items.size(); i++) {
                ...
                if (fileItem.isFormField()) {
                    ...
                    System.out.println("파일 업로드:" + fileItem.getFieldName());
